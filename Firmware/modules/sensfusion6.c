...
#define M_PI_F 3.141592653589793238462643383279502884197f
...
//#define //MADWICK_QUATERNION_IMU
  ...
  #define BETA_DEF     0.01f    // 2 * proportional gain
    ...
    #define TWO_KP_DEF  (2.0f * 20.0f) // 2 * proportional gain
    #define TWO_KI_DEF  (2.0f * 8.0f) // 2 * integral gain
#endif
